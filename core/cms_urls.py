...
urlpatterns = [
    ...
    path('pages/<int:pk>/create-summary/', cms_views.page_create_summary_view, name='page-create-summary'),
    path('pages/<int:pk>/optimize-content/', cms_views.page_optimize_content_view, name='page-optimize-content'),
    path('pages/<int:pk>/optimize-layout/', cms_views.page_optimize_layout_view, name='page-optimize-layout'),
